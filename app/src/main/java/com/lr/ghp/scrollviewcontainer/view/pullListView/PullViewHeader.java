...
import com.lr.ghp.scrollviewcontainer.utility.DateUtility;
...
public class PullViewHeader extends LinearLayout {
     ...
     */
    public PullViewHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    public void setState(int state) {
        ...
        switch(state){
            case STATE_NORMAL:
                ...
                tipsTextview.setText(getResources().getString(R.string.xlistview_header_hint_normal));

                if(lastRefreshTime==null){
                    lastRefreshTime = DateUtility.getCurrentDate(DateUtility.dateFormatHMS);
                    headerTimeView.setText(getResources().getString(R.string.xlistview_header_flush_time) + lastRefreshTime);
                }else{
                    headerTimeView.setText(getResources().getString(R.string.xlistview_header_last_time) + lastRefreshTime);
                }
            ...
            case STATE_READY:
                if (mState != STATE_READY) {
                    ...
                    tipsTextview.setText(getResources().getString(R.string.xlistview_header_hint_ready));
                    headerTimeView.setText(getResources().getString(R.string.xlistview_header_last_time) + lastRefreshTime);
                    lastRefreshTime = DateUtility.getCurrentDate(DateUtility.dateFormatHMS);
            ...
            case STATE_REFRESHING:
                tipsTextview.setText(getResources().getString(R.string.xlistview_header_hint_flush));
                headerTimeView.setText(getResources().getString(R.string.xlistview_header_nor_time) + lastRefreshTime);
                break;
            default:
        }
