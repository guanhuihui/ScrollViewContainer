...
public class PullListView extends ListView implements AbsListView.OnScrollListener {
    ...
    /**
     * 当onScroll被拦截时，使用该方法获取list的size
     */
    public void setTotalItemCount(int num){
        totalItemCount=num;
    }
    ...
    private void initView(Context context) {
        ...
        // init header view
        mHeaderView = new PullViewHeader(context);
        ...
        // init footer view
        mFooterView = new PullViewFooter(context);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                int b=getTotalItemCount();
                if (mEnablePullRefresh && getFirstVisiblePosition() == 0 && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)) {
                    updateHeaderHeight(deltaY / OFFSET_RADIO);
                } else if (mEnablePullLoad && !mPullLoading && getLastVisiblePosition() > getTotalItemCount() && deltaY<-15f) {
                    startLoadMore();
                }
                break;
